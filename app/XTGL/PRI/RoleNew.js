define(function (require, exports, module) {
    var controller = ['$scope', 'Message', 'Role', 'ngTableParams', 'Query', 'Pri', 'Menu',
     function ($scope, Message, Role, ngTableParams, Query, Pri, Menu) {
        ...
        $scope.ok = function () {
          var r =[];
            ...
            Role.save($scope.record, function(data){
                if(!data.success){
                  alert(data.msg);
                  return;
                }
