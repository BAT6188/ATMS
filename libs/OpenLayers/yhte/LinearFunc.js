...
OpenLayers.LinearFunc.get_distance = function(point1,point2){
	...
	var x1 = parseFloat(point1.x);
	var y1 = parseFloat(point1.y);
	var x2 = parseFloat(point2.x);
	var y2 = parseFloat(point2.y);
...
// console.log(OpenLayers.LinearFunc.toMC(120.505,31.252));
// console.log(OpenLayers.LinearFunc.toMC(120.658,31.328));


// console.log(OpenLayers.LinearFunc.toMC(120.5121,31.2719));
// console.log(OpenLayers.LinearFunc.toMC(120.5620,31.2834));
// console.log(OpenLayers.LinearFunc.toMC(120.5306,31.2769));
