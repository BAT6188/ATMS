...
(function($) {
  ...
  DateTimePicker.prototype = {
    ...
    init: function(element, options) {
      ...
      this.timesize =options.timesize;
      this.language = options.language in dates ? options.language : 'en'
      this.pickDate = options.pickDate;
      this.pickTime = options.pickTime;
      this.nosecond = options.nosecond;
      this.minuteno = options.minuteno;
    ...
    actions: {
      ...
      incrementMinutes: function(e) {
          var inmi=1;
          if(this.timesize!=''&&this.timesize!=null)
          {
              inmi=5;
          }
        this._date.setUTCMinutes(this._date.getUTCMinutes() + inmi);
      },

      incrementSeconds: function(e) {
          var insi=1;
          if(this.nosecond!=''&&this.nosecond!=null)
          {
              insi=0;
          }
          this._date.setUTCSeconds(this._date.getUTCSeconds() + insi);
      },
      ...
      decrementMinutes: function(e) {
        ...
        this._date.setUTCMinutes(this._date.getUTCMinutes() - dmi);
      },
      ...
      decrementSeconds: function(e) {
        ...
        this._date.setUTCSeconds(this._date.getUTCSeconds() - dsi);
      },
      ...
      showMinutes: function() {
          if(this.minuteno!=''&&this.minuteno!=null)
          {
      ...
      if (this.pickDate && this.pickTime) {
        this.widget.on('click.togglePicker', '.accordion-toggle', function(e) {
          ...
          if (expanded && expanded.length) {
            ...
            //此处与新版本bootstrap不符，新增
            expanded.on('hidden.bs.collapse', function () {
              expanded.addClass('collapse');
            });
            closed.on('shown.bs.collapse', function () {
