      ...
      link: function(scope, element, attrs) {
        ...
        isAcceptTheBroadcast = function(broadcast, modelName) {
          ...
          if (modelName) {
            ...
            if(scope.validateInModal && broadcast.targetScope === scope.$parent || !scope.validateInModal && broadcast.targetScope === scope){
      ...
      return function(value, scope, element, attrs) {
        ...
        while (parent.length !== 0) {
          // if (parent.hasClass('row')) {
            ...
            var formName = $('form').attr('name'); //add by xuzhaoyun
            scope[formName].$invalid = true; //add by xuzhaoyun
      ...
      return function(value, scope, element) {
        ...
        while (parent.length !== 0) {
          if (parent.hasClass('has-error')) {
            ...
            var formName = $('form').attr('name');  //add by xuzhaoyun
            //scope[formName].$invalid = false;  //add by xuzhaoyun


            self.validate(scope).success(function(){
